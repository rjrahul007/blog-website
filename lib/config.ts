...
export const SITE_CONFIG = {
  ...
  // Social Links
  socialLinks: {
    github: process.env.NEXT_PUBLIC_GITHUB_URL || 'https://github.com/rjrahul007',
    linkedin:
      process.env.NEXT_PUBLIC_LINKEDIN_URL || 'https://linkedin.com/in/rjrahul007',
    twitter:
  ...
  giscus: {
    ...
    categoryId: process.env.NEXT_PUBLIC_GISCUS_CATEGORY_ID || 'DIC_kwDOQ5NwtM4C09R0',
  },
} as const;
